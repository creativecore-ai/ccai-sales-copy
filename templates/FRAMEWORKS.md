# The 5 Sales Copy Frameworks

> Reference taxonomy for `ccai-sales-copy`. Framework selection is driven by audience awareness stage (see SKILL.md).
...
**Watch out:** AIDA fades if used on solution-aware audiences who already know what category they need.
...
> *That's eight hours a month of unpaid weekend work. Your spouse notices. You haven't taken a real Sunday off in a year.* [Agitation]
> *Our content planner generates the week in 12 minutes.* [Solution]
> *[CTA: See how it works →]"*

**Watch out:** Over-agitation feels manipulative. Stop when the reader nods, not when they cry.
...
> *In 30 days: you send 0 cold emails. Leads come to you. You're focused on the calls that actually close.* [After]
> *Our inbound system is the bridge. Set it up in one weekend. Run it for 30 days.* [Bridge]
> *[CTA →]"*

**Watch out:** Vague befores ("you're stuck") fail. Concrete befores ("Tuesday at 11pm you'll be re-doing the same email") win.
...
> *That's 0 calendar conflicts vs the 3-per-month average for Calendly users.* [Advantage]
> *No more 'sorry, I'm actually in Pacific time' emails on Monday mornings.* [Benefit]

**Watch out:** Most copy stops at Features. Buyers don't buy Features. They buy Benefits.
...
**Structure** (matches the four levels):

| Stage | Reader state | Copy approach |
|---|---|---|
| **Oblivious** | Doesn't know there's a problem | Surface the problem with curiosity-piquing data ("Did you know X?") |
| **Apathetic** | Knows there's a problem, doesn't care | Show the *future* cost of not caring ("Five years of this and...") |
| **Thinking** | Actively shopping for solutions | Drop the agitation, lead with proof and differentiation |
| **Hurting** | In pain, ready to act now | Reduce friction. Skip persuasion. Get to the CTA fast. |

**Use OATH to:** match the tone of your hook + early body to where the reader actually is. Mismatch = bounce.
...
- **AIDA top-of-page + PAS in scroll-depth sections + FAB at decision point** for long-form sales pages

When in doubt: open with the framework that matches awareness stage, then escalate as the reader moves down the page.

---

*Reference file for ccai-sales-copy. Frameworks synthesized from direct response copywriting practice and 2026 hybrid-framework analyses.*
